    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-amber-50">
        ...
        <section className="py-16 bg-gradient-to-r from-amber-700 to-amber-800 text-white">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-white" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
              Are You an Artist?
            </h2>
            <p className="text-lg mb-8 max-w-2xl mx-auto text-white/90" style={{ fontFamily: 'Poppins, sans-serif' }}>
